...
def data_processing():
    ...
    classes = []
    documents = []
    data_file = open('conversation/models/intents.json', encoding='UTF-8').read()
    ...
    pickle.dump(words, open('conversation/models/words.pkl', 'wb'))
    pickle.dump(classes, open('conversation/models/classes.pkl', 'wb'))
...
def train_model():
    ...
    model.save('conversation/models/chatbot_model.h5', history)
