...
Pylint: 10.00 (September 13, 2022)
...
def load_unique_names():
    ...
    with open('smart_assistant/recognition/face/models/names_small.txt', 'r', encoding='utf-8') as file:
        for line in file:
            new_item = line[:-1]
...
def train():
    ...
    x_train, y_train, unique_names = get_known_info()
...
if __name__ == "__main__":
    try:
        testing_model = load_model('smart_assistant/recognition/face/models/face_model_small.h5')
        NAMES = load_unique_names()
    except OSError:
        testing_model, NAMES = train()
