...
def new_person(name, image="", voice=""):
    ...
    :param name: A String representing the new persons name.
    :param image: A String representation of the new persons face image.
    :param voice: A String representation of the new persons voice recording.
    """
